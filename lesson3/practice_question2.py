...
# words of verse stored as keys and the number of times they appear in verse
# stored as values. Use this dictionary to answer the following questions.
...
# Hint: Use the appropriate dictionary method to get a list of its keys, and
# then sort that list. Use this list of keys to answer the next two questions
# as well.
