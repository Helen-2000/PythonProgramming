...
# Print out a string of the form "This week's total sales: xxx", where xxx
# will be the actual total of all the numbers. You’ll need to change the type
# of the input data in order to calculate that total.
